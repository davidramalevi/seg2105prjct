        ...
        if(user == null){
            ...
            ref.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    if("Admin".equals(role_db)){
                        Intent intent_admin = new Intent(getApplicationContext(), MainActivity_Admin.class);
                        startActivity(intent_admin);
                        finish();
                    }
                    else if("Club Owner".equals(role_db)){
                        Intent intent_club = new Intent(getApplicationContext(), MainActivity_Clubowner.class);
                        startActivity(intent_club);
                        finish();
                    }
                    else{
                        Intent intent_part = new Intent(getApplicationContext(), MainActivity_Participant.class);
                        startActivity(intent_part);
                        finish();
                    }
                }
