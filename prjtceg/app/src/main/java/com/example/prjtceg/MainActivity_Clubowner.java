...
public class MainActivity_Clubowner extends AppCompatActivity {
    FirebaseAuth auth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_clubowner);
        ...
        if(user == null){
            ...
            try{
                ...
                Toast.makeText(MainActivity_Clubowner.this, "ERROR.",
